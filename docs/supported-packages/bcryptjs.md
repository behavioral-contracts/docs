...
**ℹ️ INFO - hash-version-compatibility**
...
📖 [Source](https://blog.ircmaxell.com/2012/12/seven-ways-to-screw-up-bcrypt.html)
...
📖 [Source](https://github.com/dcodeIO/bcrypt.js#usage---async)

#### Edge Cases

Known gotchas and sharp edges:

**⚠️ WARNING - browser-rng-requirement**
...
📖 [Source](https://github.com/dcodeIO/bcrypt.js#random-numbers)
